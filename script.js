...
/* ==========================================================================
   UDESAKEN - ENVIO DE PARCERIA VIA WEBHOOK DISCORD
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (formParceria) {
        formParceria.addEventListener('submit', async (e) => {
            ...
            // 2. Monta o visual da mensagem que vai chegar no Discord
            ...
            const payload = {
                embeds: [{
                    ...
                    color: isOficial ? 16766720 : 2829617, // Dourado (16766720) ou Cinza Escuro (2829617)
                    fields: [
            ...
            // 3. Muda o texto do botão para "Enviando..."
            ...
            try {
                // 4. Dispara a mensagem pro seu Webhook
                const webhookURL = 'https://discord.com/api/webhooks/1482585442061647873/ok-wPw0017qQ5e07I7U6BsWz7gLICBePFGtakLr4Bm0f8yLIT-AZG9X6eVRVA9MdbFHR';
                ...
                if (response.ok) {
                    // 5. Deu certo! Redireciona o dono do grupo para o WhatsApp de triagem
                    const linkGrupoEspera = "https://chat.whatsapp.com/HqRNjrQzRJ87K112xJcOvm?mode=gi_t"; 
                    window.location.href = linkGrupoEspera;
                } else {
                    throw new Error('Falha de comunicação com o Discord');
                }
